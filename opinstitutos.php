...
margin-top: 20px;
margin-left: 98px;
margin-bottom: 30px;">Sistema de Comentários</h2>
<?php 
	$qn=mysql_query("select *from opinioes where id_institutos!=false order by id_opinioes desc ");
...
<form action="copinstitutos.php?h=1" method="POST">
	...
	<label>Sobre que institutos queres opinar?:</label><select style="width:554px; height:30px; name="sobre">
	<option></option>
	<?php  
	$t=mysql_query("select *from institutos");
